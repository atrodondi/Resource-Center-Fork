...
describe("Register New User", () => {
  it("should register a new user to the app, and bring user to dashboard/homescreen", async () => {
    ...
    try {
      ...
      // here should probably add finding the welcome message on the dashboard to confirm that they are on the dashboard, this just confirms they the button was clicked.
    } finally {
      await driver.quit();
    }
  });
